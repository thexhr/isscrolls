...
static struct command commands[] = {
	...
	{ "startautojournal", cmd_startautojournal, "Start saving commands automatically to the journal", 0, 0},
	{ "stopautojournal", cmd_stopautojournal, "Stop saving commands automatically to the journal", 0, 0},
